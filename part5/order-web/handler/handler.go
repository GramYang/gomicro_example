...
import (
	...
	auth "gomicro_example/part5/auth/proto/auth"
	invS "gomicro_example/part5/inventory-srv/proto/inventory"
	order "gomicro_example/part5/order-srv/proto/order"
	"gomicro_example/part5/plugins/session"
)
